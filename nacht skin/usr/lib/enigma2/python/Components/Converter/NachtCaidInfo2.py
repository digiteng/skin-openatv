...
class NachtCaidInfo2(Poll, Converter, object):
	CAID = 0
	PID = 1
	PROV = 2
	ALL = 3
	...
	def __init__(self, type):
		...
		if type == "CAID":
			...
			self.type = self.POWERVU
		elif type == "PowerVuEcm":
			self.type = self.POWERVU_C
	...
	def getBoolean(self):
		try:
			...
			import sys
			with open("/tmp/NachtCaidInfo2.log", "a+") as f:
				f.write("NachtCaidInfo2, {}, line:{}\n".format(err, sys.exc_info()[2].tb_lineno))
