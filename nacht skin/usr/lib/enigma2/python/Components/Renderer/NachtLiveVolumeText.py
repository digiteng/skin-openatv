...
# <widget render="NachtLiveVolumeText" source="global.CurrentTime" position="42,9" size="200,22" font="Regular; 18" zPosition="3" backgroundColor="background" transparent="1" />
...
class NachtLiveVolumeText(Renderer, VariableText):
